...
def main():
    ...
    e = 0.005 # 允许的违规率
    t = int(np.ceil(e*sum((len(arr) for arr in data))))  # 假设一开始不满足3个需求
    now_sla = t
    ...
    task_needs = [1, 2, 3]  # 假设每种类型的任务需求值 cpu
    vm_resources = [100,120,130]  # 初始化每种类型的虚拟机资源 cpu
